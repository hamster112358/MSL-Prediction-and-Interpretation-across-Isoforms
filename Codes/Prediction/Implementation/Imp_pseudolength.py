...
# Get predictions
    ...
    print(f" Processed all {len(sequences)} sequences.\n")
    return predictions, label_names

def save_predictions(predictions, label_names, output_file='Probabilities.csv'):
...
# Main Function
def main():
    FASTA_FILE = "Data/Raw/pseudo_fasta.txt"      
    MODEL_PATH = "Codes/Prediction/Implementation/model.pth"                
    OUTPUT_FILE = "Data/Main/Prediciton_pseudolength.csv"          
    BATCH_SIZE = 32                           
    THRESHOLD = 0.5  
    
    # Model hyperparameters acquired from the taining mode
    MODEL_CONFIG = {
        'resnet_dim': 64,
        'MHA_num': 6,
        'input_dim': 2048,
    ...
    try:
        ...
        # Detect the true hyperparameters during the trainging
