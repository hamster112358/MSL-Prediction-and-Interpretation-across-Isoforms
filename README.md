...
### Phase 1: Full Transcript Interpretative Pipeline
...
### Phase 2: 3' Untranslated Region (UTR) Architecture
...
4. **Single-Cell Transcriptomics Integration:** To eliminate low-expression artifacts, scRNA-seq matrices were pseudo-bulked by cell type to calculate Counts Per Million (CPM). Transcripts were required to pass an absolute floor of 0.28 CPM. Genes exhibiting high isoform usage similarity (transcript cosine similarity > 0.8) were discarded to guarantee genuine tissue-specific expression divergence.
