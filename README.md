...
5. **SCL and RBP Divergence Filtering:**: Genes were required to have at least two different RBP patterns. Those who had all the isoforms containing exactly the same RBP patterns were discarded. Genes were also required to have a high differential SCL assignments across isoforms. Cosine similarity was calculated and the minimum was recorded for isoforms within each gene. Genes with minimum value higher than 0.6 were discarded.
